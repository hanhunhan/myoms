...
class Field{
	...
	protected $ENCRY          =null;//字段值加*号的起止位置 ,起止值中间用逗号隔开
	protected $UPLOADURL          ='index.php?s=/Upload/save2oracle/';//自定义文件上传程序URL 
    ...
    public function creatFormColsHtml($model,$param=null) {
		...
		if($this->TRANSFER && $this->DBBOUND==-1){
			...
			if($param['FORMTYPE'] == 'FORM') //隐藏 or 换行 
			{
