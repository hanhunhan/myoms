...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    * @param string $type "pre", "output", бн specify the filter type to set. Defaults to none treating $filters' keys as the appropriate types
    * @return Smarty current Smarty instance for chaining
    */
    ...
    * @return array array( 'type1' => array( 'filter1', 'filter2', бн ) ) or array( 'filter1', 'filter2', бн) if $type was specified
    */
