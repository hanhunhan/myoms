...
<div class="notice">
<h2>?????????? </h2>
<div >????????? [ <A HREF="<?php echo(strip_tags($_SERVER['PHP_SELF']))?>">????</A> ] [ <A HREF="javascript:history.back()">????</A> ] ???? [ <A HREF="<?php echo(__APP__);?>">??????</A> ]</div>
<?php if(isset($e['file'])) {?>
<p><strong>????λ??:</strong>??FILE: <span class="red"><?php echo $e['file'] ;?></span>??LINE: <span class="red"><?php echo $e['line'];?></span></p>
<?php }?>
<p class="title">[ ??????? ]</p>
