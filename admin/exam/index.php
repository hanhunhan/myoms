...
<table border="0" cellspacing="1" width="99%" class="small" bgcolor="#000000" cellpadding="3">
  <tr class="TableHeader">
	...
	<td align="center">试题左</td>
	<td align="center">试题右</td>
	<td align="center" width="100">试题维度</td>
	<td align="center" width="120">操作</td>
  </tr>

  <?
	$sql = "SELECT {$tbl}.*, zzqf_dimension.title dtitle FROM {$tbl} LEFT JOIN zzqf_dimension ON {$tbl}.did=zzqf_dimension.id where 1".$where." ORDER BY ID DESC";
	$rs = exequery($connection,$sql);
	...
	while($r = mysql_fetch_array($rs)){
		...
		foreach($options as $vo){
			$str_option .= $vo[0]."&nbsp;&nbsp;".$vo[1]."分 <br />";
		}
?>
  <tr class="<?=$TableLine?>">
	<td nowrap align="center" style="padding-left:5px;"><?=$r[id]?></td>
	<td align="left" style="padding-left:5px;"><?=$r[title_left]?></td>
	<td align="left" style="padding-left:5px;"><?=$r[title_right]?></td>
	<td nowrap align="center" style="padding-left:5px;"><?=$r[dtitle]?></td>
