...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		less: {
			...
			uncompressed: {
				files: {
					'selectize/dist/css/selectize.css': ['dist/less/selectize.less'],
					'selectize/dist/css/selectize.default.css': ['dist/less/selectize.default.less'],
					'selectize/dist/css/selectize.legacy.css': ['dist/less/selectize.legacy.less'],
					'selectize/dist/css/selectize.bootstrap2.css': ['dist/less/selectize.bootstrap2.tmp.less'],
					'selectize/dist/css/selectize.bootstrap3.css': ['dist/less/selectize.bootstrap3.tmp.less']
				}
			}
		},
		concat: {
