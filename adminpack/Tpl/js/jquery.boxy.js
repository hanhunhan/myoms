...
Boxy.prototype = {
    ...
    centerAt: function(x, y) {
        ...
        if (typeof y == 'number') ( y - s[1] / 2 < 0 ? this.moveToY(0) : this.moveToY(y - s[1] / 2) );
        return this;
    },
    ...
    show: function() {
        ...
        if (this.options.modal) {
            ...
            this.modalBlackout = jQuery('<div class="boxy-modal-blackout" ><iframe src="about:blank" style="width:100%;height:100%;filter:alpha(opacity=0);opacity:0;scrolling=no;z-index:99999"></iframe></div>')
