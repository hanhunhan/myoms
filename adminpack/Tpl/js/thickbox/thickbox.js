    ...
    try {
        ...
        if (j == '.jpg' || j == '.jpeg' || j == '.png' || j == '.gif' || j == '.bmp') {
            ...
            imgPreloader.onload = function () {
                ...
                TB_WIDTH = b + 30;
                TB_HEIGHT = c + 60;
                $("#TB_window").append("<a href='' id='TB_ImageOff' title='¹Ø±Õ'><img id='TB_Image' src='" + f + "' width='" + b + "' height='" + c + "' alt='" + d + "'/></a>" + "<div id='TB_caption'>" + d + "<div id='TB_secondLine'>" + TB_imageCount + TB_PrevHTML + TB_NextHTML + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='¹Ø±Õ'>[X]</a></div>");
            ...
            if (f.indexOf('TB_iframe') != -1) {
                ...
                if (m['modal'] != "true") {
                    $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>" + d + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='¹Ø±Õ'>[X]</a></div></div><iframe frameborder='0' hspace='0' src='" + urlNoQuery[0] + "' id='TB_iframeContent' name='TB_iframeContent" + Math.round(Math.random() * 1000) + "' onload='tb_showIframe()' style='width:" + (ajaxContentW + 29) + "px;height:" + (ajaxContentH + 17) + "px;' > </iframe>")
                } else {
                    $("#TB_overlay").unbind();
                ...
                if ($("#TB_window").css("display") != "block") {
                    if (m['modal'] != "true") {
                        $("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>" + d + "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton'>close</a></div></div><div id='TB_ajaxContent' style='width:" + ajaxContentW + "px;height:" + ajaxContentH + "px'></div>")
                    } else {
                        $("#TB_overlay").unbind();
