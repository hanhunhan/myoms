...
class ProjectIncomeModel extends Model{
    ...
    private $_conf_status_from_map = array(
                                         '1' => array(1),
                                         '2' => array(2),
                                         '3' => array(3, 8, 12, 16,19, 20,23),
                                         '4' => array(7, 11, 15,21,22)
                                     );
     ...
     * @param  int     $income_info['ORG_ENTITY_ID']  原始业务实体编号 【必填】
     * @param  int     $income_info['ORG_PAY_ID']  原始收入明细编号 【必填】
